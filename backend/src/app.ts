...
export const buildApp = async () => {
  ...
  // API routes
  await fastify.register(authRoutes, { prefix: `/${config.app.apiVersion}/auth` });
  await fastify.register(propertiesRoutes, { prefix: `/${config.app.apiVersion}/properties` });
  await fastify.register(roomsRoutes, { prefix: `/${config.app.apiVersion}/rooms` });
  await fastify.register(templesRoutes, { prefix: `/${config.app.apiVersion}/temples` });
  await fastify.register(bookingsRoutes, { prefix: `/${config.app.apiVersion}/bookings` });
  await fastify.register(paymentsRoutes, { prefix: `/${config.app.apiVersion}/payments` });
  await fastify.register(reviewsRoutes, { prefix: `/${config.app.apiVersion}/reviews` });
  await fastify.register(wishlistRoutes, { prefix: `/${config.app.apiVersion}/wishlist` });
  await fastify.register(vendorRoutes, { prefix: `/${config.app.apiVersion}/vendor` });
  await fastify.register(adminRoutes, { prefix: `/${config.app.apiVersion}/admin` });

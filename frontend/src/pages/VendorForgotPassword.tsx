...
import { Mail, ArrowRight, CheckCircle, Building2, Sparkles } from "lucide-react";
...
const VendorForgotPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.vendor.forgotPassword(email);
      setIsSent(true);
      toast({
        title: "Email sent!",
        ...
        >
          ...
          <div className="bg-card/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-border/50 p-8 space-y-6">
            ...
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary/10 to-gold/10 text-primary px-4 py-2 rounded-full text-sm font-semibold shadow-sm mx-auto">
                <Building2 className="w-4 h-4" />
                Vendor Portal
              </div>
              <h1 className="text-2xl md:text-3xl font-serif font-bold text-foreground pt-2">
                Check Your Email
              </h1>
      ...
      >
        ...
        >
          <div className="text-center space-y-3">
            ...
            <p className="text-muted-foreground">
              Enter your vendor email and we'll send you a reset link
            </p>
          </div>
